...
def main() -> int:
    ...
    if len(sys.argv) == 3:
        try:
            max_gap_bars = int(sys.argv[2])
        except ValueError:
            print("max_gap_bars must be an integer.")
            return 1
    ...
    for i in range(len(rows) - 1):
        ...
        earlier_bar = earlier["bar_index"]
        later_bar = later["bar_index"]
        gap_bars = later_bar - earlier_bar
