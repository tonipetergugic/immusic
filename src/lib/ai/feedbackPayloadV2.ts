...
// NACHHER: Dynamics Health Index v2 (rein technisch, interpretierbar, nicht geschmacksbasiert)
function computeDynamicsHealthV1(input: {
  lufs: number | null | undefined;
  lra: number | null | undefined;
  crest: number | null | undefined;

  // Phase 2 v2 inputs (optional, falls nicht vorhanden -> neutral/reweighted)
  ...
  // optional: Hinweis auf hartes Limiting/Clipping (Source TP overs events)
