...
export async function writeFeedbackPayloadIfUnlocked(params: {
  ...
  const { data: mRow, error: mErr } = await adminClient
    ...
    .select(
      [
        ...
        "low_end_phase_corr_20_60",
        "low_end_phase_corr_60_120",
  ...
  const payload: FeedbackPayloadV2 = buildFeedbackPayloadV2Mvp({
    ...
    lowEndPhaseCorrelation20_60: m?.low_end_phase_corr_20_60 ?? null,
    lowEndPhaseCorrelation60_120: m?.low_end_phase_corr_60_120 ?? null,
