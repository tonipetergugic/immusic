...
export default function PlaylistHeaderClient({
  ...
  "
      ...
      `}
        >
          <div className="relative w-48 h-48 rounded-xl overflow-hidden border border-[#1A1A1C] bg-gradient-to-br from-neutral-900 to-neutral-800 flex items-center justify-center">
            {playlist.cover_url ? (
              <Image
