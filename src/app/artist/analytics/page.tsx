        ...
        <>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
            <div className="xl:col-span-2 space-y-4">
              <ChartCard title="Streams over time" subtitle="Line preview (data later)" kind="line" />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <ChartCard title="Top tracks" subtitle="Bars preview (data later)" kind="bars" />
                <ChartCard title="Discovery sources" subtitle="Bars preview (data later)" kind="bars" />
              </div>
            </div>

            <div className="space-y-4">
              <ChartCard title="Conversion" subtitle="Saves per listener (preview)" kind="line" />
            </div>
          </div>
        </>
      )}
