      ...
      <section className="border-b border-white/10 pb-10">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/20 px-3 py-2 backdrop-blur-sm transition hover:border-white/20 focus-within:border-[#00FFC6]/40 focus-within:ring-2 focus-within:ring-[#00FFC6]/35">
